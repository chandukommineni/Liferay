package com.aixtor.student.rest.builder.dto.v1_0;
...
public class StudentObject implements Serializable {
	...
	public String toString() {
		...
		if (studentEnrollmentNo != null) {
			...
			sb.append(_escape(studentEnrollmentNo));
	...
	@Schema(
		...
		defaultValue = "com.aixtor.student.rest.builder.dto.v1_0.StudentObject",
		name = "x-class-name"
	)
