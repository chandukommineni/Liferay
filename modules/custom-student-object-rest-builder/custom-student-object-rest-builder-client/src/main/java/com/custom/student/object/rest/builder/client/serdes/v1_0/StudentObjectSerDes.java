package com.custom.student.object.rest.builder.client.serdes.v1_0;

import com.custom.student.object.rest.builder.client.dto.v1_0.StudentObject;
import com.custom.student.object.rest.builder.client.json.BaseJSONParser;
...
public class StudentObjectSerDes {
	...
	public static String toJSON(StudentObject studentObject) {
		...
		if (studentObject.getEnrollmentNo() != null) {
			...
			sb.append(_escape(studentObject.getEnrollmentNo()));
	...
	public static Map<String, String> toMap(StudentObject studentObject) {
		...
		if (studentObject.getEnrollmentNo() == null) {
			...
			map.put(
				"enrollmentNo",
				String.valueOf(studentObject.getEnrollmentNo()));
		}
	...
	public static class StudentObjectJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "enrollmentNo")) {
				if (jsonParserFieldValue != null) {
					studentObject.setEnrollmentNo((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "studentDepartment")) {
				if (jsonParserFieldValue != null) {
