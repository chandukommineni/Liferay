package com.custom.student.object.rest.builder.resource.v1_0.test;

import com.custom.student.object.rest.builder.client.dto.v1_0.StudentObject;
import com.custom.student.object.rest.builder.client.http.HttpInvoker;
import com.custom.student.object.rest.builder.client.pagination.Page;
import com.custom.student.object.rest.builder.client.pagination.Pagination;
import com.custom.student.object.rest.builder.client.resource.v1_0.StudentsResource;
...
public abstract class BaseStudentsResourceTestCase {
	...
	protected void assertValid(StudentObject studentObject) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("enrollmentNo", additionalAssertFieldName)) {
				if (studentObject.getEnrollmentNo() == null) {
					valid = false;
				}
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("enrollmentNo", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						studentObject1.getEnrollmentNo(),
						studentObject2.getEnrollmentNo())) {
	...
	protected StudentObject randomStudentObject() throws Exception {
		return new StudentObject() {
			{
				enrollmentNo = RandomTestUtil.randomString();
	...
	@Inject
	private
		com.custom.student.object.rest.builder.resource.v1_0.StudentsResource
			_studentsResource;
